...
- **Игра "Kitten Cards** - в папке Kitten Cards Game (JS, Express,CSS)
- **Модуль администрирования и пользователя приложения продажи акций** - в папке Broker App (TypeScript, Vue)
